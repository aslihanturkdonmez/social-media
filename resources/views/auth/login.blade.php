...
<html lang="tr">
    ...
    <body class="antialiased">
        <div class="relative flex items-top min-h-screen sm:items-center py-4 sm:pt-0">
                    ...
                    @else
                        <div class="grid grid-cols-2">
                            ...
                            <div class="ml-40 mt-5">
                                <a href="{{ route('login') }}" class="rounded btn1 text-xl ">Giriş Yap</a>&nbsp;&nbsp;

                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="rounded btn2 text-xl ">Kayıt Ol</a>
                                @endif
                            </div>
                        </div>
                    @endauth
            ...
            <div class="justify-center mt-28 max-w-6xl w-6xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <x-jet-validation-errors class="mb-4" />
                                ...
                                <form method="POST" action="{{ route('login') }}" class="ml-4 mr-4">
                                    ...
                                    <div class="flex items-center justify-end mt-4">
                                        ...
                                        <button class="rounded btn3 fw-bold text-lg ml-4">
                                            {{ __('Giriş Yap') }}
                                        </button>
                                    </div>
                                </form>
