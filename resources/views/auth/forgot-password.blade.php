...
<html lang="tr">
    ...
    <body class="antialiased">
        <div class="relative d-flex justify-content-around items-top min-h-screen sm:items-center sm:pt-0">
            ...
            <div class="justify-center mt-20 max-w-3xl mx-auto sm:px-6 lg:px-8">
                <div class="formbody overflow-hidden shadow-lg p-6 pl-10 sm:rounded-lg">
                    <x-guest-layout>
                        <div class="mb-4 mt-4 text-mb text-gray-600">
                            {{ __('Parolanızı mı unuttunuz? Sorun değil. Bize e-posta adresinizi bildirin ve size yeni bir tane seçmenize izin verecek bir şifre sıfırlama bağlantısı gönderelim.') }}
                        </div>
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="block">
                                ...
                                <x-jet-input id="email" class="block mt-1 w-50" type="email" name="email" :value="old('email')" placeholder="ogrencinumaraniz@ogrenci.btu.edu.tr" required autofocus />
                            </div>

                            <div class="flex items-left  mt-4">
                                <x-jet-button>
                                    {{ __('Şifre Sıfırlama Maili Gönder') }}
                                </x-jet-button>
                            </div>
                        </form>
                    </x-guest-layout>
